  ...
  return async (dispatch, getState) => {
    ...
    try {
      const { data } = await axois.get(
        `https://esoul.onrender.com/api/products/top`,
      )
  ...
  return async (dispatch, getState) => {
    ...
    try {
      const { data } = await axois.put(
        `https://esoul.onrender.com/api/products/${productID}/reviews`,
        review,
        config
      )
...
export const editProduct = (product,productID) => {
  return async (dispatch, getState) => {
    ...
    try {
      const { data } = await axois.put(`https://esoul.onrender.com/api/products/${productID}`, product, config)
...
export const createProduct = () => {
  return async (dispatch, getState) => {
    ...
    try {
      const { data } = await axois.post(`https://esoul.onrender.com/api/products`,{}, config)
...
export const deleteProduct = (id) => {
  return async (dispatch,getState) => {
    ...
    try {
      const { data } = await axois.delete(`https://esoul.onrender.com/api/products/${id}`,config)
...
export const fetchAllProducts = (keyword='',pageNumber='') => {
    ...
    return async (dispatch) => {
        ...
        try {
            const { data } = await axois.get(`https://esoul.onrender.com/api/products?keyword=${keyword}&&page=${pageNumber}`)
...
export const fetchProductDetail = (id) => {
  return async (dispatch) => {
    ...
    try {
      const { data } = await axois.get(`https://esoul.onrender.com/api/products/${id}`)
...
export const deleteUser = (id) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axois.delete(`https://esoul.onrender.com/api/user/${id}`, config)
...
export const getAllUsers = () => {
  return async (dispatch,getState) => {
    try {
      ...
      const { data } = await axois.get(`https://esoul.onrender.com/api/user`, config)
...
export const loginUser = (email,password) => {
  return async (dispatch,getState)=>{
    try {
      ...
      const {data} = await axois.post('https://esoul.onrender.com/api/user/login',{email,password},config)
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axois.post(
        'https://esoul.onrender.com/api/user',
        {name, email, password },
        config
      )
...
export const getUserDetails = (id) => {
  return async (dispatch,getState) => {
    try {
      ...
      const {data} = await axois.get(`https://esoul.onrender.com/api/user/${id}`,config)
...
export const updateUserProfile = (user) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axois.put(`https://esoul.onrender.com/api/user/profile`,user, config)
...
export const updateUserByID = (user) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data } = await axois.put(`https://esoul.onrender.com/api/user/${user._id}`, user, config)
...
export const placeOrder = (data) => {
  return async (dispatch,getState) => {
    try {
      ...
      const { data:orderData } = await axois.post(`https://esoul.onrender.com/api/orders`,data, config)
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const { data: orderData } = await axois.put(
        `https://esoul.onrender.com/api/orders/${orderID}/delievered`,{},
        config
      )
...
export const getAllOrders = ()=>{
  return async (dispatch, getState) => {
    try {
      ...
      const { data: orderData } = await axois.get(`https://esoul.onrender.com/api/orders/all`, config)
  ...
  return async (dispatch,getState) => {
    try {
      ...
      const { data: orderData } = await axois.get(
        `https://esoul.onrender.com/api/orders`,
        config
      )
...
export const payOrder = (orderId,paymentResult) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data: orderData } = await axois.put(`https://esoul.onrender.com/api/orders/${orderId}/pay`, paymentResult ,config)
...
export const getOrderDetails = (id) => {
  return async (dispatch, getState) => {
    try {
      ...
      const { data: orderData } = await axois.get(`https://esoul.onrender.com/api/orders/${id}`, config)
